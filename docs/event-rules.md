...
| Submission includes the Codex Session ID for the core-functionality task | Capture from the Codex UI and store only in private submission notes, never in the repository. | Operator ⛔ | Pending |
