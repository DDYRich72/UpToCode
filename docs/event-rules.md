...
| Demo contains no third-party trademarks or copyrighted material | Capture only UpToCode-owned UI, checked-in fixtures, terminal output, and narration; no third-party logos, marks, or music. | Codex: guardrails; operator ⛔: final review | Guardrails ready |
