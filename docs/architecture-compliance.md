...
| AA006 | Sensitive values are redacted before report, judgment, log, or GitHub workflow-command egress. | `redaction.py`, dedicated injection-safe GitHub reporter, payload-free hosted middleware and operations policy | `test_gate1.py`, `test_github_ci_surface.py`, `test_judgment.py`, `test_rule_contract_matrix.py` |
